...
void ex::algorithm::noise::ImprovedPerlinNoise::_bind_methods() {
	ClassDB::bind_compatibility_method(D_METHOD("get_noise2d_at", "x", "y"), &ImprovedPerlinNoise::get_noise2d_at);
	ClassDB::bind_compatibility_method(D_METHOD("get_noise3d_at", "x", "y", "z"), &ImprovedPerlinNoise::get_noise3d_at);
}
...
real_t ex::algorithm::noise::ImprovedPerlinNoise::grad(int8_t hash, real_t x, real_t y, real_t z) {
	int8_t h = hash & 15;
	double u = h < 8 ? x : y;
...
void ex::algorithm::noise::ImprovedPerlinNoise::_init_noise() {
...
ex::algorithm::noise::ImprovedPerlinNoise::ImprovedPerlinNoise() : BasicNoise() {}

ex::algorithm::noise::ImprovedPerlinNoise::ImprovedPerlinNoise(uint64_t seed) : BasicNoise(seed) {
	
}

real_t ex::algorithm::noise::ImprovedPerlinNoise::get_noise2d_at(real_t x, real_t y) {
	return this->get_noise3d_at(x, y, 0.0);
}

real_t ex::algorithm::noise::ImprovedPerlinNoise::get_noise3d_at(real_t x, real_t y, real_t z) {
